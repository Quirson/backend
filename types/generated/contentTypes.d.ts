...
export interface ApiGroupGroup extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    group_members: Schema.Attribute.Relation<
      'manyToMany',
      'api::profile.profile'
    >;
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::group.group'> &
      Schema.Attribute.Private;
    memberCount: Schema.Attribute.BigInteger;
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiPostPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    shares: Schema.Attribute.BigInteger & Schema.Attribute.DefaultTo<'0'>;
...
export interface ApiProfileProfile extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    followers: Schema.Attribute.Relation<'oneToMany', 'api::profile.profile'>;
    followersCount: Schema.Attribute.BigInteger &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    following: Schema.Attribute.Relation<'oneToMany', 'api::profile.profile'>;
    followingCount: Schema.Attribute.BigInteger &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    isVerified: Schema.Attribute.Boolean &
      ...
      Schema.Attribute.DefaultTo<false>;
    likedPost: Schema.Attribute.Relation<'manyToMany', 'api::post.post'>;
    ...
    website: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'www.socialDeal.com'>;
  };
}
...
export interface ApiStoryStory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    viewers: Schema.Attribute.BigInteger;
  };
}
